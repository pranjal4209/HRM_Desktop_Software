...
namespace HRM_SUB
{
    public partial class EmailAndChat : Form
    {
        ...
        private void EmailAndChat_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                pictureBox2.Image = new Bitmap("C:\\Users\\Pranjal.mishra\\Desktop\\HRM_Software-master\\img\\User Photo\\" + currentUser.id + ".png");
                pictureCurrentUser.Image = new Bitmap("C:\\Users\\Pranjal.mishra\\Desktop\\HRM_Software-master\\img\\User Photo\\" + currentUser.id + ".png");
            }
            catch (Exception ex)
            {
                pictureBox2.Image = new Bitmap("C:\\Users\\Pranjal.mishra\\Desktop\\HRM_Software-master\\img\\User Photo\\default.png");
                pictureCurrentUser.Image = new Bitmap("C:\\Users\\Pranjal.mishra\\Desktop\\HRM_Software-master\\img\\User Photo\\default.png");
            }
        }
        ...
        private void userInfoGet(object sender, EventArgs e)
        {
            ...
            if (lb != null)
            {
                ...
                try
                {
                    pictureBox1.Image = new Bitmap("C:\\Users\\Pranjal.mishra\\Desktop\\HRM_Software-master\\img\\User Photo\\" + secendUser.id + ".png");
                }
                catch (Exception ex)
                {
                    pictureBox1.Image = new Bitmap("C:\\Users\\Pranjal.mishra\\Desktop\\HRM_Software-master\\img\\User Photo\\default.png");
                }
            }
        }
        ...
        private void editOnChange(object sender, EventArgs e)
        {
            ...
            try
            {
                pictureSecendUser.Image = new Bitmap("C:\\Users\\Pranjal.mishra\\Desktop\\HRM_Software-master\\img\\User Photo\\" + secendUser.id + ".png");
            }
            catch (Exception ex)
            {
                pictureSecendUser.Image = new Bitmap("C:\\Users\\Pranjal.mishra\\Desktop\\HRM_Software-master\\img\\User Photo\\default.png");
            }
        }
