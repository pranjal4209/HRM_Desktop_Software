...
namespace HRM_SUB
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                pictureBoxProfile.Image = new Bitmap("C:\\Users\\Pranjal.mishra\\Desktop\\HRM_Software-master\\img\\User Photo\\" + currentUser.id + ".png");
            }
            catch (Exception ex)
            {
                pictureBoxProfile.Image = new Bitmap("C:\\Users\\Pranjal.mishra\\Desktop\\HRM_Software-master\\img\\User Photo\\default.png");
            }
        ...
        public void loadUserProfile(string UserId)
        {
            try
            {
                ...
                while (reader.Read())
                {
                    log.Info("your data has been loaded successfully.");
        ...
        private void panel_employee_MouseDown_1(object sender, MouseEventArgs e)
        {
            ...
            if (employeeForm == null)
            {
                ...
                // employeeForm.FormClosed += employeeForm_FormClosed;
                log.Error("Employee form opened successfully");
                employeeForm.Show();
